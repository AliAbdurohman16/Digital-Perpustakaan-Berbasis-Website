        ...
        <div class="row">
            <div class="col-12 mt-4">
                <div class="d-grid gap-2 d-md-flex">
                    <button class="btn btn-primary mb-3 btn-sm" data-bs-toggle="modal" data-bs-target="#add-modal">Tambah Data +</button>
                </div>
                            ...
                            <tbody>
                                ...
                                @foreach($categories as $category)
                                    <tr>
                                        ...
                                        <td style="width: 25%;">
                                            <button type="button" class="btn btn-warning btn-sm mb-2" data-bs-toggle="modal" data-bs-target="#edit-modal{{ $category->id }}">Edit</button>
                                            <button type="button" class="btn btn-danger btn-sm mb-2 btn-delete" data-id="{{ $category->id }}">Hapus</button>
                                        </td>
                                    </tr>
                                @endforeach
                                <!-- End -->
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label">Nama Kategori<span class="text-danger">*</span></label>
                                <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ $category->name }}" placeholder="Nama Kategori" required>
                                @error('name')
                                    <span class="invalid-feedback errorname" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
