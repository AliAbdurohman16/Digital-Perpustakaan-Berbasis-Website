                            ...
                            <div class="row">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-3 mb-2">
                                                <img src="{{ asset('storage/covers/' . $book->cover) }}" width="100px" alt="image" class="img-thumbnail cover-preview">
                                            </div>
                                            <div class="col-sm-9">
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input name="title" id="title" type="text" class="form-control @error('title') is-invalid @enderror" placeholder="Judul Buku" value="{{ $book->title }}">
                                        @error('title')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input name="amount" id="amount" type="number" class="form-control @error('amount') is-invalid @enderror" placeholder="Jumlah Buku" value="{{ $book->amount }}">
                                        @error('amount')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="description" id="summernote" rows="4" class="form-control @error('description') is-invalid @enderror" placeholder="Deskripsi Buku">{{ $book->description }}</textarea>
                                        @error('description')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
