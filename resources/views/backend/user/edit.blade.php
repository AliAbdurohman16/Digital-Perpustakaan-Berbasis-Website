                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input name="fullname" id="fullname" type="text" class="form-control @error('fullname') is-invalid @enderror" placeholder="Nama Lengkap" value="{{ $user->fullname }}">
                                        @error('fullname')
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input name="email" id="email" type="email" class="form-control @error('email') is-invalid @enderror" placeholder="Email" value="{{ $user->email }}">
                                        @error('email')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select name="role" id="role" class="form-control @error('role') is-invalid @enderror">
                                            ...
                                            <option value="admin" {{ $user->getRoleNames()->implode(', ') == 'admin' ? 'selected' : '' }}>Admin</option>
                                            <option value="user" {{ $user->getRoleNames()->implode(', ') == 'user' ? 'selected' : '' }}>User</option>
                                        </select>
                                        @error('role')
                                            <div class="invalid-feedback">
                                                {{ $message }}
